...
export default function UseState(props: Props) {
    return(
        <>
            ...
            <p className="text-white m-2 text-xl">useState is the first and most common "hook". As their name implies, hooks are gonna be ways of waiting for something to happen, to make something happen. Could be an event, like clicking a button, or might as well be the hover of an image.</p> <br />

            <p className="text-white m-2 text-xl">Let's get right into it. We'll first need to import useState, just like how we did with the previous imports from the previous React concepts examples.</p>
            ...
            <p className="text-white m-2 text-xl">Notice we're deconstructing the import to bring just useState, and not the whole <code>"react"</code> library. This is part of must-have good practices in React, for performance and code quality in general!</p> <br />

            <p className="text-white m-2 text-xl">Then, we'll start setting up our useState, by destructuring it as it is an array:</p>
            ...
            <p className="text-white m-2 text-xl">The vriable and the function must always have the same name, except the function has to have "<code className="font-bold">set</code>" at its beginnning. <br />
            ...
            <p className="text-white m-2 text-xl">In short, useState's variable is what holds whatever you'd want to show in your JSX. <br />
            ...
            <p className="text-white m-2 text-xl">The particularity of it is that to change the state value, you always have to pass through its function, which has to be called in another function to keep the naming and code clear.</p> <br />

            <p className="text-white m-2 text-xl">For example, we could want a function that adds +1 to the state value, whlie having another that decrements -1. That would require 2 different functions, that pass through the useState function. That would make working a simple count.</p> <br />

            <p className="text-white m-2 text-xl">Let's use our state with the goal of displaying a different pizza on a button's click, while keeping the pizza theme from the previous <a href="#props" className="text-blue-200"><code className="font-bold underline">props</code></a> React concept seen earlier.</p> <br />

            <p className="text-white m-2 text-xl">That means we can already ready our JSX to hold the data we want when we take a look at our <a className="text-blue-200 underline" href="#MOCKUP-DATA-SETUP">JSON mock data</a>. (← click for the setup part if you don't have the mock data). <br />
            Let's take a look:</p>

            <img className="w-xl mx-auto" src={dataFields} alt="" />

            <p className="text-white m-2 text-xl">We know we'll need placeholders for the "<code className="font-bold">pizza</code>" (pizza name), the <code className="font-bold">description</code> and the <code className="font-bold">price</code>. <br />
    ...
    <div className='flex flex-col items-center justify-center border-5 rounded-lg p-5 m-2 border-white'>
        ...
        <p className='text-white italic font-bold'>{pizza.price}€</p>
            ...
            <p className="text-white m-2 text-xl">And for the more technical part of how we're going to use our State "dynamically", we're going to make a few buttons for a few pizzas from our data, and each will display the according pizza's data on click. <br />
    ...
    <button>
        <li className='w-full bg-blue-300 hover:bg-blue-200 p-3 rounded-lg text-center'>Pizza salmon & cream</li>
            ...
            <p className="text-white m-2 text-xl">Now, in vanilla JS & HTML, to add an "event listener" to run some code whenever the user will do something, like click a button for example, you'd normally do something like this: </p>
...
<script>
    document.getElementById("myButton").addEventListener("click", function () {
        alert("Button clicked!");
            ...
            <p className="text-white m-2 text-xl">Doing this might not seem very long to write with habit, but React still makes it faster. <br />
            ...
            <p className="text-white m-2 text-xl">Take a look at how it's done:</p>
    ...
    return(
        ...
        <button onClick={myFunction}>Click me</button>
            ...
            <p className="text-white m-2 text-xl">Basically, we make a function that will run whenever the event will be toggled. <br />
            ...
            <p className="text-white m-2 text-xl">This is basically how you link the Javascript code to actually make things move the JSX !</p> <br />

            <p className="text-white m-2 text-xl">Now, all that's left to do is: <br />
            ...
            <p className="text-white m-2 text-xl">We now have all the keys in our hands. Please don't mind giving it a try yourself before wtaching the solution, we're reaching the end !</p> <br />

            <p className="text-white m-2 text-xl">Let's take a look at a function that calls for a specific <b>pizza object</b>, through its <code className="font-bold">ID</code>:</p>
            <div className='bg-gray-700 m-2'>
                <code className="block text-white m-5 text-xl whitespace-pre overflow-x-auto break-keep">
        ...
        setPizza(prevState => ({
            ...
            <p className="text-white m-2 text-xl">This function first calls the <code className="font-bold">setter</code> (useState function) to update the state value. <br /> <br />
            ...
            <p className="text-white m-2 text-xl">Let's also take a look at our modified JSX (buttons & data placeholders):</p>
    ...
    <div className='flex flex-col text-center max-w-96'>
            ...
            <p className="text-white m-2 text-xl">If you take a look at our buttons, they do have the function set as their <code className="font-bold"> onClick</code> event. <br />
            ...
            <p className="text-white m-2 text-xl">Finally, we can see our JSX data placeholders call for the <b><code>useState</code> variable properties</b>, so we can keep on having our JSX "layout" ready. <br />
            ...
            <p className="text-white m-2 text-xl">Annnnd... There we are, the end, again! Congrats if you made it this far. <br />
            ...
            <p className="text-white m-2 text-xl">Preview:</p>
            <br /><StateMenu />
        </>
    )
}